    ...
    <form class="max-w-3xl" wire:submit="save">
        <div class="divide-y divide-workspace-divider rounded-workspace border border-workspace-divider bg-workspace-surface px-4 sm:px-6">
            <section class="py-5 sm:py-6" aria-labelledby="profile-identity-heading">
                <div class="mb-5">
                    <h2 id="profile-identity-heading" class="font-bold text-workspace-text">اطلاعات پایه</h2>
                    <p class="mt-1 text-sm leading-6 text-workspace-muted">نامی که در پنل و فعالیت‌های شما نمایش داده می‌شود.</p>
                </div>
            ...
            <section class="py-5 sm:py-6" aria-labelledby="profile-security-heading">
                <div class="mb-5">
                    <h2 id="profile-security-heading" class="font-bold text-workspace-text">امنیت حساب</h2>
                    <p class="mt-1 text-sm leading-6 text-workspace-muted">برای نگه‌داشتن رمز فعلی، این بخش را خالی بگذارید.</p>
                </div>
                <div class="grid gap-4 sm:grid-cols-2">
            ...
            <section class="py-5 sm:py-6" aria-labelledby="profile-access-heading">
                <div class="mb-3">
                    <h2 id="profile-access-heading" class="font-bold text-workspace-text">سطح دسترسی</h2>
                    <p class="mt-1 text-sm leading-6 text-workspace-muted">این موارد برای حفظ دسترسی درست به فضاهای کاری قابل ویرایش نیستند.</p>
                </div>
                <p class="text-sm leading-6 text-workspace-muted">ایمیل، نقش، مشتری و وضعیت حساب فقط توسط ادمین مدیریت می‌شوند.</p>
            </section>
