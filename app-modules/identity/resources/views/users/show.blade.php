<div class="space-y-6">
    ...
    <div class="grid gap-5 xl:grid-cols-[2fr_1fr]">
        <form wire:submit="saveProfile">
            <div class="space-y-4">
                <x-ui.card title="اطلاعات تماس" subtitle="ایمیل و موبایل برای ارتباط با این کاربر استفاده می‌شوند.">
                    <div class="space-y-5">
                ...
                <x-ui.card title="دسترسی و امنیت">
                    <div class="space-y-5">
        ...
        <div class="space-y-5">
            ...
            <x-ui.card title="پروژه‌های فعال عضو" subtitle="عضویت‌هایی که هنوز فعال هستند.">
                <div class="space-y-2">
