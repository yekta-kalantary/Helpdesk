<div>
    <section aria-labelledby="reset-password-heading">
        <div class="mb-5"><h1 id="reset-password-heading" class="text-heading-lg font-semibold text-text">تنظیم رمز عبور</h1><p class="mt-1 text-body-sm leading-6 text-text-muted">یک رمز عبور جدید برای حساب خود تعیین کنید.</p></div>
