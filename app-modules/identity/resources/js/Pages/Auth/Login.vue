        ...
        <section class="relative w-full max-w-[25rem]">
            ...
            <div class="rounded-lg border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <form class="space-y-4" @submit.prevent="submit">
                    ...
                    <label v-if="auth.canRememberSession" class="flex min-h-10 items-center gap-2.5 text-sm text-slate-600">
                        <input v-model="form.remember" type="checkbox" name="remember" class="size-3.5 rounded border-slate-300 text-teal-700 focus:ring-teal-600" />
                    ...
                    <a
                        ...
                        class="block min-h-10 pt-2 text-center text-sm font-medium text-teal-800 underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-teal-700"
                    >
