        ...
        <x-ui.card>
            <div class="space-y-5">
                ...
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <x-ui.checkbox name="portal_enabled" :label="__('customers::messages.portal_enabled')" model="portal_enabled" :live="true" />
                ...
                <x-ui.form-actions>
                    ...
                    <x-ui.button variant="secondary" :href="route('customers.index')" icon="fa-xmark" wire:navigate>{{ __('app.cancel') }}</x-ui.button>
                </x-ui.form-actions>
            </div>
        </x-ui.card>
    </form>
