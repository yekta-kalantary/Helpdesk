...
it('renders accessible guest auth forms with labels, actions, and loading states', function (): void {
    $this->get(route('login'))
        ...
        ->assertSee(__('app.email'))
        ->assertSee('for="password"', false)
        ->assertSee('name="password"', false)
        ->assertSee(__('app.password'))
    ...
    $this->get(route('password.request'))
        ...
        ->assertSee('wire:loading.remove wire:target="send"', false)
        ->assertSee('wire:loading', false)
    ...
    $this->get(route('password.reset', ['token' => 'test-token']).'?email=reset@example.test')
        ...
        ->assertSee('wire:loading.remove wire:target="resetPassword"', false)
        ->assertSee('wire:loading', false)
